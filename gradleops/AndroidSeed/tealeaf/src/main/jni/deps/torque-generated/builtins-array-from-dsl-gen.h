...
class ArrayBuiltinsFromDSLAssembler: public ArrayBuiltinsAssembler {
 public:
  ...
  TNode<Object> FastArrayForEach(TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, Label* label_Bailout_66, TVariable<Smi>* Bailout0_88);
  TNode<Object> LoadWithHoleCheck12ATFixedArray(TNode<FixedArrayBase> p_elements, TNode<Smi> p_index, Label* label_IfHole_83);
  TNode<Object> LoadWithHoleCheck18ATFixedDoubleArray(TNode<FixedArrayBase> p_elements, TNode<Smi> p_index, Label* label_IfHole_86);
  TNode<Number> GetFromIndex(TNode<Context> p_context, TNode<Number> p_length, CodeStubArguments* p_arguments);
  TNode<Object> TryFastArrayLastIndexOf(TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<Object> p_searchElement, TNode<Number> p_from, Label* label_Slow_91);
  ...
  void TryFastPackedArrayReverse(TNode<Object> p_receiver, Label* label_Slow_125);
  ...
  TNode<Object> FastArraySplice(TNode<Context> p_context, CodeStubArguments* p_args, TNode<JSReceiver> p_o, TNode<Number> p_originalLengthNumber, TNode<Number> p_actualStartNumber, TNode<Smi> p_insertCount, TNode<Number> p_actualDeleteCountNumber, Label* label_Bailout_135);
  ...
  void TryFastArrayUnshift(TNode<Context> p_context, TNode<Object> p_receiver, CodeStubArguments* p_arguments, Label* label_Slow_191);
  ...
  TNode<Number> CallCompareFn(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<Object> p_x, TNode<Object> p_y, Label* label_Bailout_862);
  ...
  void EnsureSuccess(TNode<FixedArray> p_sortState, Label* label_Bailout_875);
  TNode<Smi> Failure(TNode<FixedArray> p_sortState);
  TNode<Object> CallLoad(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<Code> p_load, TNode<HeapObject> p_elements, TNode<Smi> p_index, Label* label_Bailout_878);
  void CallStore(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<Code> p_store, TNode<HeapObject> p_elements, TNode<Smi> p_index, TNode<Object> p_value, Label* label_Bailout_879);
  void CallCopyFromTempArray(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<HeapObject> p_dstElements, TNode<Smi> p_dstPos, TNode<FixedArray> p_tempArray, TNode<Smi> p_srcPos, TNode<Smi> p_length, Label* label_Bailout_880);
  void CallCopyWithinSortArray(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<HeapObject> p_elements, TNode<Smi> p_srcPos, TNode<Smi> p_dstPos, TNode<Smi> p_length, Label* label_Bailout_881);
  TNode<Smi> CallGallopRight(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<Code> p_load, TNode<Object> p_key, TNode<Smi> p_base, TNode<Smi> p_length, TNode<Smi> p_hint, TNode<Oddball> p_useTempArray, Label* label_Bailout_882);
  TNode<Smi> CallGallopLeft(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<Code> p_load, TNode<Object> p_key, TNode<Smi> p_base, TNode<Smi> p_length, TNode<Smi> p_hint, TNode<Oddball> p_useTempArray, Label* label_Bailout_883);
  void CallMergeAt(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<Smi> p_i, Label* label_Bailout_884);
  TNode<Smi> GetReceiverLengthProperty(TNode<Context> p_context, TNode<FixedArray> p_sortState);
  void CopyToTempArray(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<Code> p_load, TNode<HeapObject> p_srcElements, TNode<Smi> p_srcPos, TNode<FixedArray> p_tempArray, TNode<Smi> p_dstPos, TNode<Smi> p_length, Label* label_Bailout_887);
  TNode<Smi> CountAndMakeRun(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<Smi> p_lowArg, TNode<Smi> p_high, Label* label_Bailout_942);
  void ReverseRange(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<Code> p_load, TNode<Code> p_store, TNode<HeapObject> p_elements, TNode<Smi> p_from, TNode<Smi> p_to, Label* label_Bailout_959);
  void CopyElement(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<Code> p_load, TNode<Code> p_store, TNode<HeapObject> p_elements, TNode<Smi> p_from, TNode<Smi> p_to, Label* label_Bailout_1087);
  void MergeLow(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<Smi> p_baseA, TNode<Smi> p_lengthAArg, TNode<Smi> p_baseB, TNode<Smi> p_lengthBArg, Label* label_Bailout_1088);
  void MergeHigh(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<Smi> p_baseA, TNode<Smi> p_lengthAArg, TNode<Smi> p_baseB, TNode<Smi> p_lengthBArg, Label* label_Bailout_1150);
  ...
  void MergeCollapse(TNode<Context> p_context, TNode<FixedArray> p_sortState, Label* label_Bailout_1224);
  void MergeForceCollapse(TNode<Context> p_context, TNode<FixedArray> p_sortState, Label* label_Bailout_1234);
  ...
  void ArrayTimSortImpl(TNode<Context> p_context, TNode<FixedArray> p_sortState, TNode<Smi> p_length, Label* label_Bailout_1240);
  void VisitAllElements18ATFixedDoubleArray(TNode<Context> p_context, TNode<JSArray> p_a, TNode<Smi> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, Label* label_Bailout_1286, TVariable<Smi>* Bailout0_518);
  void VisitAllElements12ATFixedArray(TNode<Context> p_context, TNode<JSArray> p_a, TNode<Smi> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, Label* label_Bailout_1297, TVariable<Smi>* Bailout0_520);
  ...
  void FastSplice12ATFixedArray22UT12ATHeapObject5ATSmi(CodeStubArguments* p_args, TNode<JSArray> p_a, TNode<Smi> p_length, TNode<Smi> p_newLength, TNode<Smi> p_lengthDelta, TNode<Smi> p_actualStart, TNode<Smi> p_insertCount, TNode<Smi> p_actualDeleteCount, Label* label_Bailout_1332);
  void FastSplice18ATFixedDoubleArray22UT12ATHeapNumber5ATSmi(CodeStubArguments* p_args, TNode<JSArray> p_a, TNode<Smi> p_length, TNode<Smi> p_newLength, TNode<Smi> p_lengthDelta, TNode<Smi> p_actualStart, TNode<Smi> p_insertCount, TNode<Smi> p_actualDeleteCount, Label* label_Bailout_1346);
