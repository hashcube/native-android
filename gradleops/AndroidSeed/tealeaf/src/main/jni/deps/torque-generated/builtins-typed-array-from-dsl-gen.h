...
class TypedArrayBuiltinsFromDSLAssembler: public TypedArrayBuiltinsAssembler {
 public:
  ...
  TNode<Number> CallCompareWithDetachedCheck(TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_comparefn, TNode<Object> p_a, TNode<Object> p_b, Label* label_Detached_205);
  void TypedArrayInsertionSort(TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<Smi> p_fromArg, TNode<Smi> p_toArg, TNode<JSReceiver> p_comparefn, TNode<Code> p_load, TNode<Code> p_store, Label* label_Detached_210);
  void TypedArrayQuickSortImpl(TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<Smi> p_fromArg, TNode<Smi> p_toArg, TNode<JSReceiver> p_comparefn, TNode<Code> p_load, TNode<Code> p_store, Label* label_Detached_219);
};
